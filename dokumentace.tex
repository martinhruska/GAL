...
to modify algorithm for simulation computation over NTA from \cite{ilie:nta} which has complexity $O(m*n)$.
...
We implemented our method as module to VATA library using its infrastructure for manipulation NTA.
